...
#define LOW_PRECISION`),e}const Zf={[os]:"SHADOWMAP_TYPE_PCF",[Ai]:"SHADOWMAP_TYPE_VSM"};function Jf(i){return Zf[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Qf={[Wn]:"ENVMAP_TYPE_CUBE",[di]:"ENVMAP_TYPE_CUBE",[gs]:"ENVMAP_TYPE_CUBE_UV"};function ep(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Qf[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const tp={[di]:"ENVMAP_MODE_REFRACTION"};function np(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":tp[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const ip={[wo]:"ENVMAP_BLENDING_MULTIPLY",[Hc]:"ENVMAP_BLENDING_MIX",[Wc]:"ENVMAP_BLENDING_ADD"};function sp(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":ip[i.combine]||"ENVMAP_BLENDING_NONE"}function rp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function ap(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Jf(t),c=ep(t),u=np(t),d=sp(t),f=rp(t),m=Hf(t),_=Wf(r),x=s.createProgram();let p,h,E=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+h);const b=E+p+a,S=E+h+o,A=fo(s,s.VERTEX_SHADER,b),w=fo(s,s.FRAGMENT_SHADER,S);s.attachShader(x,A),s.attachShader(x,w),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(P){if(i.debug.checkShaderErrors){const B=s.getProgramInfoLog(x)||"",F=s.getShaderInfoLog(A)||"",V=s.getShaderInfoLog(w)||"",q=B.trim(),z=F.trim(),H=V.trim();let K=!0,ie=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,A,w);else{const te=mo(s,A,"vertex"),re=mo(s,w,"fragment");Ye("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,yp=[new O(1,0,0),new O(-1,0,0),new O(0,1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1)],Ep=[new O(0,-1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1),new O(0,-1,0),new O(0,-1,0)],Eo=new ut,Ti=new O,tr=new O;function bp(i,e,t){let n=new la;const s=new qe,r=new qe,a=new mt,o=new Il,l=new Ul,c={},u=t.maxTextureSize,d={[vn]:It,[It]:vn,[yt]:yt},f=new cn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:Mp,fragmentShader:Sp}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const _=new Ut;_.setAttribute("position",new rn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new xe(_,f),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=os;let h=this.type;this.render=function(w,R,U){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;w.type===bc&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),w.type=os);const v=i.getRenderTarget(),y=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),B=i.state;B.setBlending(_n),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const F=h!==this.type;F&&R.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach(q=>q.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,q=w.length;V<q;V++){const z=w[V],H=z.shadow;if(H===void 0){Ie("WebGLShadowMap:",z,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);const K=H.getFrameExtents();if(s.multiply(K),r.copy(H.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/K.x),s.x=r.x*K.x,H.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/K.y),s.y=r.y*K.y,H.mapSize.y=r.y)),H.map===null||F===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===Ai){if(z.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new sn(s.x,s.y,{format:fi,type:Mn,minFilter:_t,magFilter:_t,generateMipmaps:!1}),H.map.texture.name=z.name+".shadowMap",H.map.depthTexture=new Li(s.x,s.y,en),H.map.depthTexture.name=z.name+".shadowMapDepth",H.map.depthTexture.format=Sn,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Et,H.map.depthTexture.magFilter=Et}else{z.isPointLight?(H.map=new Qo(s.x),H.map.depthTexture=new Dl(s.x,an)):(H.map=new sn(s.x,s.y),H.map.depthTexture=new Li(s.x,s.y,an)),H.map.depthTexture.name=z.name+".shadowMap",H.map.depthTexture.format=Sn;const te=i.state.buffers.depth.getReversed();this.type===os?(H.map.depthTexture.compareFunction=te?sa:ia,H.map.depthTexture.minFilter=_t,H.map.depthTexture.magFilter=_t):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Et,H.map.depthTexture.magFilter=Et)}H.camera.updateProjectionMatrix()}const ie=H.map.isWebGLCubeRenderTarget?6:1;for(let te=0;te<ie;te++){if(H.map.isWebGLCubeRenderTarget)i.setRenderTarget(H.map,te),i.clear();else{te===0&&(i.setRenderTarget(H.map),i.clear());const re=H.getViewport(te);a.set(r.x*re.x,r.y*re.y,r.x*re.z,r.y*re.w),B.viewport(a)}if(z.isPointLight){const re=H.camera,ne=H.matrix,Pe=z.distance||re.far;Pe!==re.far&&(re.far=Pe,re.updateProjectionMatrix()),Ti.setFromMatrixPosition(z.matrixWorld),re.position.copy(Ti),tr.copy(re.position),tr.add(yp[te]),re.up.copy(Ep[te]),re.lookAt(tr),re.updateMatrixWorld(),ne.makeTranslation(-Ti.x,-Ti.y,-Ti.z),Eo.multiplyMatrices(re.projectionMatrix,re.matrixWorldInverse),H._frustum.setFromProjectionMatrix(Eo,re.coordinateSystem,re.reversedDepth)}else H.updateMatrices(z);n=H.getFrustum(),S(R,U,H.camera,z,this.type)}H.isPointLightShadow!==!0&&this.type===Ai&&E(H,U),H.needsUpdate=!1}h=this.type,p.needsUpdate=!1,i.setRenderTarget(v,y,P)};function E(w,R){const U=e.update(x);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new sn(s.x,s.y,{format:fi,type:Mn})),f.uniforms.shadow_pass.value=w.map.depthTexture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(R,null,U,f,x,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(R,null,U,m,x,null)}function b(w,R,U,v){let y=null;const P=U.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)y=P;else if(y=U.isPointLight===!0?l:o,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const B=y.uuid,F=R.uuid;let V=c[B];V===void 0&&(V={},c[B]=V);let q=V[F];q===void 0&&(q=y.clone(),V[F]=q,R.addEventListener("dispose",A)),y=q}if(y.visible=R.visible,y.wireframe=R.wireframe,v===Ai?y.side=R.shadowSide!==null?R.shadowSide:R.side:y.side=R.shadowSide!==null?R.shadowSide:d[R.side],y.alphaMap=R.alphaMap,y.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,y.map=R.map,y.clipShadows=R.clipShadows,y.clippingPlanes=R.clippingPlanes,y.clipIntersection=R.clipIntersection,y.displacementMap=R.displacementMap,y.displacementScale=R.displacementScale,y.displacementBias=R.displacementBias,y.wireframeLinewidth=R.wireframeLinewidth,y.linewidth=R.linewidth,U.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const B=i.properties.get(y);B.light=U}return y}function S(w,R,U,v,y){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===Ai)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,w.matrixWorld);const F=e.update(w),V=w.material;if(Array.isArray(V)){const q=F.groups;for(let z=0,H=q.length;z<H;z++){const K=q[z],ie=V[K.materialIndex];if(ie&&ie.visible){const te=b(w,ie,v,y);w.onBeforeShadow(i,w,R,U,F,te,K),i.renderBufferDirect(U,null,F,te,w,K),w.onAfterShadow(i,w,R,U,F,te,K)}}}else if(V.visible){const q=b(w,V,v,y);w.onBeforeShadow(i,w,R,U,F,q,null),i.renderBufferDirect(U,null,F,q,w,null),w.onAfterShadow(i,w,R,U,F,q,null)}}const B=w.children;for(let F=0,V=B.length;F<V;F++)S(B[F],R,U,v,y)}function A(w){w.target.removeEventListener("dispose",A);for(const U in c){const v=c[U],y=w.target.uuid;y in v&&(v[y].dispose(),delete v[y])}}}const Tp={[sr]:rr,[ar]:lr,[or]:hr,[ui]:cr,[rr]:sr,[lr]:ar,[hr]:or,[cr]:ui};function Ap(i,e){function t(){let D=!1;const fe=new mt;let ee=null;const pe=new mt(0,0,0,0);return{setMask:function(J){ee!==J&&!D&&(i.colorMask(J,J,J,J),ee=J)},setLocked:function(J){D=J},setClear:function(J,Z,se,Le,at){at===!0&&(J*=Le,Z*=Le,se*=Le),fe.set(J,Z,se,Le),pe.equals(fe)===!1&&(i.clearColor(J,Z,se,Le),pe.copy(fe))},reset:function(){D=!1,ee=null,pe.set(-1,0,0,0)}}}function n(){let D=!1,fe=!1,ee=null,pe=null,J=null;return{setReversed:function(Z){if(fe!==Z){const se=e.get("EXT_clip_control");Z?se.clipControlEXT(se.LOWER_LEFT_EXT,se.ZERO_TO_ONE_EXT):se.clipControlEXT(se.LOWER_LEFT_EXT,se.NEGATIVE_ONE_TO_ONE_EXT),fe=Z;const Le=J;J=null,this.setClear(Le)}},getReversed:function(){return fe},setTest:function(Z){Z?$(i.DEPTH_TEST):le(i.DEPTH_TEST)},setMask:function(Z){ee!==Z&&!D&&(i.depthMask(Z),ee=Z)},setFunc:function(Z){if(fe&&(Z=Tp[Z]),pe!==Z){switch(Z){case sr:i.depthFunc(i.NEVER);break;case rr:i.depthFunc(i.ALWAYS);break;case ar:i.depthFunc(i.LESS);break;case ui:i.depthFunc(i.LEQUAL);break;case or:i.depthFunc(i.EQUAL);break;case cr:i.depthFunc(i.GEQUAL);break;case lr:i.depthFunc(i.GREATER);break;case hr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pe=Z}},setLocked:function(Z){D=Z},setClear:function(Z){J!==Z&&(fe&&(Z=1-Z),i.clearDepth(Z),J=Z)},reset:function(){D=!1,ee=null,pe=null,J=null,fe=!1}}}function s(){let D=!1,fe=null,ee=null,pe=null,J=null,Z=null,se=null,Le=null,at=null;return{setTest:function(Je){D||(Je?$(i.STENCIL_TEST):le(i.STENCIL_TEST))},setMask:function(Je){fe!==Je&&!D&&(i.stencilMask(Je),fe=Je)},setFunc:function(Je,Zt,ln){(ee!==Je||pe!==Zt||J!==ln)&&(i.stencilFunc(Je,Zt,ln),ee=Je,pe=Zt,J=ln)},setOp:function(Je,Zt,ln){(Z!==Je||se!==Zt||Le!==ln)&&(i.stencilOp(Je,Zt,ln),Z=Je,se=Zt,Le=ln)},setLocked:function(Je){D=Je},setClear:function(Je){at!==Je&&(i.clearStencil(Je),at=Je)},reset:function(){D=!1,fe=null,ee=null,pe=null,J=null,Z=null,se=null,Le=null,at=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let u={},d={},f=new WeakMap,m=[],_=null,x=!1,p=null,h=null,E=null,b=null,S=null,A=null,w=null,R=new Xe(0,0,0),U=0,v=!1,y=null,P=null,B=null,F=null,V=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,H=0;const K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(K)[1]),z=H>=1):K.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),z=H>=2);let ie=null,te={};const re=i.getParameter(i.SCISSOR_BOX),ne=i.getParameter(i.VIEWPORT),Pe=new mt().fromArray(re),Fe=new mt().fromArray(ne);function Ve(D,fe,ee,pe){const J=new Uint8Array(4),Z=i.createTexture();i.bindTexture(D,Z),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let se=0;se<ee;se++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(fe,0,i.RGBA,1,1,pe,0,i.RGBA,i.UNSIGNED_BYTE,J):i.texImage2D(fe+se,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,J);return Z}const Y={};Y[i.TEXTURE_2D]=Ve(i.TEXTURE_2D,i.TEXTURE_2D,1),Y[i.TEXTURE_CUBE_MAP]=Ve(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Y[i.TEXTURE_2D_ARRAY]=Ve(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Y[i.TEXTURE_3D]=Ve(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),$(i.DEPTH_TEST),a.setFunc(ui),Ue(!1),it(Ea),$(i.CULL_FACE),We(_n);function $(D){u[D]!==!0&&(i.enable(D),u[D]=!0)}function le(D){u[D]!==!1&&(i.disable(D),u[D]=!1)}function we(D,fe){return d[D]!==fe?(i.bindFramebuffer(D,fe),d[D]=fe,D===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=fe),D===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=fe),!0):!1}function me(D,fe){let ee=m,pe=!1;if(D){ee=f.get(fe),ee===void 0&&(ee=[],f.set(fe,ee));const J=D.textures;if(ee.length!==J.length||ee[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,se=J.length;Z<se;Z++)ee[Z]=i.COLOR_ATTACHMENT0+Z;ee.length=J.length,pe=!0}}else ee[0]!==i.BACK&&(ee[0]=i.BACK,pe=!0);pe&&i.drawBuffers(ee)}function ke(D){return _!==D?(i.useProgram(D),_=D,!0):!1}const lt={[zn]:i.FUNC_ADD,[Ac]:i.FUNC_SUBTRACT,[wc]:i.FUNC_REVERSE_SUBTRACT};lt[Rc]=i.MIN,lt[Cc]=i.MAX;const De={[Pc]:i.ZERO,[Dc]:i.ONE,[Lc]:i.SRC_COLOR,[nr]:i.SRC_ALPHA,[Bc]:i.SRC_ALPHA_SATURATE,[Fc]:i.DST_COLOR,[Uc]:i.DST_ALPHA,[Ic]:i.ONE_MINUS_SRC_COLOR,[ir]:i.ONE_MINUS_SRC_ALPHA,[Oc]:i.ONE_MINUS_DST_COLOR,[Nc]:i.ONE_MINUS_DST_ALPHA,[kc]:i.CONSTANT_COLOR,[zc]:i.ONE_MINUS_CONSTANT_COLOR,[Gc]:i.CONSTANT_ALPHA,[Vc]:i.ONE_MINUS_CONSTANT_ALPHA};function We(D,fe,ee,pe,J,Z,se,Le,at,Je){if(D===_n){x===!0&&(le(i.BLEND),x=!1);return}if(x===!1&&($(i.BLEND),x=!0),D!==Tc){if(D!==p||Je!==v){if((h!==zn||S!==zn)&&(i.blendEquation(i.FUNC_ADD),h=zn,S=zn),Je)switch(D){case li:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ba:i.blendFunc(i.ONE,i.ONE);break;case Ta:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Aa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ye("WebGLState: Invalid blending: ",D);break}else switch(D){case li:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ba:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ta:Ye("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Aa:Ye("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ye("WebGLState: Invalid blending: ",D);break}E=null,b=null,A=null,w=null,R.set(0,0,0),U=0,p=D,v=Je}return}J=J||fe,Z=Z||ee,se=se||pe,(fe!==h||J!==S)&&(i.blendEquationSeparate(lt[fe],lt[J]),h=fe,S=J),(ee!==E||pe!==b||Z!==A||se!==w)&&(i.blendFuncSeparate(De[ee],De[pe],De[Z],De[se]),E=ee,b=pe,A=Z,w=se),(Le.equals(R)===!1||at!==U)&&(i.blendColor(Le.r,Le.g,Le.b,at),R.copy(Le),U=at),p=D,v=!1}function $e(D,fe){D.side===yt?le(i.CULL_FACE):$(i.CULL_FACE);let ee=D.side===It;fe&&(ee=!ee),Ue(ee),D.blending===li&&D.transparent===!1?We(_n):We(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);const pe=D.stencilWrite;o.setTest(pe),pe&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),dt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?$(i.SAMPLE_ALPHA_TO_COVERAGE):le(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ue(D){y!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),y=D)}function it(D){D!==yc?($(i.CULL_FACE),D!==P&&(D===Ea?i.cullFace(i.BACK):D===Ec?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):le(i.CULL_FACE),P=D}function C(D){D!==B&&(z&&i.lineWidth(D),B=D)}function dt(D,fe,ee){D?($(i.POLYGON_OFFSET_FILL),(F!==fe||V!==ee)&&(i.polygonOffset(fe,ee),F=fe,V=ee)):le(i.POLYGON_OFFSET_FILL)}function Ke(D){D?$(i.SCISSOR_TEST):le(i.SCISSOR_TEST)}function tt(D){D===void 0&&(D=i.TEXTURE0+q-1),ie!==D&&(i.activeTexture(D),ie=D)}function ve(D,fe,ee){ee===void 0&&(ie===null?ee=i.TEXTURE0+q-1:ee=ie);let pe=te[ee];pe===void 0&&(pe={type:void 0,texture:void 0},te[ee]=pe),(pe.type!==D||pe.texture!==fe)&&(ie!==ee&&(i.activeTexture(ee),ie=ee),i.bindTexture(D,fe||Y[D]),pe.type=D,pe.texture=fe)}function T(){const D=te[ie];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function g(){try{i.compressedTexImage2D(...arguments)}catch(D){Ye("WebGLState:",D)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(D){Ye("WebGLState:",D)}}function W(){try{i.texSubImage2D(...arguments)}catch(D){Ye("WebGLState:",D)}}function j(){try{i.texSubImage3D(...arguments)}catch(D){Ye("WebGLState:",D)}}function X(){try{i.compressedTexSubImage2D(...arguments)}catch(D){Ye("WebGLState:",D)}}function Se(){try{i.compressedTexSubImage3D(...arguments)}catch(D){Ye("WebGLState:",D)}}function ae(){try{i.texStorage2D(...arguments)}catch(D){Ye("WebGLState:",D)}}function ye(){try{i.texStorage3D(...arguments)}catch(D){Ye("WebGLState:",D)}}function Ce(){try{i.texImage2D(...arguments)}catch(D){Ye("WebGLState:",D)}}function Q(){try{i.texImage3D(...arguments)}catch(D){Ye("WebGLState:",D)}}function ce(D){Pe.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),Pe.copy(D))}function Me(D){Fe.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),Fe.copy(D))}function Ee(D,fe){let ee=c.get(fe);ee===void 0&&(ee=new WeakMap,c.set(fe,ee));let pe=ee.get(D);pe===void 0&&(pe=i.getUniformBlockIndex(fe,D.name),ee.set(D,pe))}function oe(D,fe){const pe=c.get(fe).get(D);l.get(fe)!==pe&&(i.uniformBlockBinding(fe,pe,D.__bindingPointIndex),l.set(fe,pe))}function ze(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},ie=null,te={},d={},f=new WeakMap,m=[],_=null,x=!1,p=null,h=null,E=null,b=null,S=null,A=null,w=null,R=new Xe(0,0,0),U=0,v=!1,y=null,P=null,B=null,F=null,V=null,Pe.set(0,0,i.canvas.width,i.canvas.height),Fe.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:$,disable:le,bindFramebuffer:we,drawBuffers:me,useProgram:ke,setBlending:We,setMaterial:$e,setFlipSided:Ue,setCullFace:it,setLineWidth:C,setPolygonOffset:dt,setScissorTest:Ke,activeTexture:tt,bindTexture:ve,unbindTexture:T,compressedTexImage2D:g,compressedTexImage3D:L,texImage2D:Ce,texImage3D:Q,updateUBOMapping:Ee,uniformBlockBinding:oe,texStorage2D:ae,texStorage3D:ye,texSubImage2D:W,texSubImage3D:j,compressedTexSubImage2D:X,compressedTexSubImage3D:Se,scissor:ce,viewport:Me,reset:ze}}function wp(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new qe,u=new WeakMap;let d;const f=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,g){return m?new OffscreenCanvas(T,g):ms("canvas")}function x(T,g,L){let W=1;const j=ve(T);if((j.width>L||j.height>L)&&(W=L/Math.max(j.width,j.height)),W<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const X=Math.floor(W*j.width),Se=Math.floor(W*j.height);d===void 0&&(d=_(X,Se));const ae=g?_(X,Se):d;return ae.width=X,ae.height=Se,ae.getContext("2d").drawImage(T,0,0,X,Se),Ie("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+X+"x"+Se+")."),ae}else return"data"in T&&Ie("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),T;return T}function p(T){return T.generateMipmaps}function h(T){i.generateMipmap(T)}function E(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(T,g,L,W,j=!1){if(T!==null){if(i[T]!==void 0)return i[T];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let X=g;if(g===i.RED&&(L===i.FLOAT&&(X=i.R32F),L===i.HALF_FLOAT&&(X=i.R16F),L===i.UNSIGNED_BYTE&&(X=i.R8)),g===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(X=i.R8UI),L===i.UNSIGNED_SHORT&&(X=i.R16UI),L===i.UNSIGNED_INT&&(X=i.R32UI),L===i.BYTE&&(X=i.R8I),L===i.SHORT&&(X=i.R16I),L===i.INT&&(X=i.R32I)),g===i.RG&&(L===i.FLOAT&&(X=i.RG32F),L===i.HALF_FLOAT&&(X=i.RG16F),L===i.UNSIGNED_BYTE&&(X=i.RG8)),g===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(X=i.RG8UI),L===i.UNSIGNED_SHORT&&(X=i.RG16UI),L===i.UNSIGNED_INT&&(X=i.RG32UI),L===i.BYTE&&(X=i.RG8I),L===i.SHORT&&(X=i.RG16I),L===i.INT&&(X=i.RG32I)),g===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(X=i.RGB8UI),L===i.UNSIGNED_SHORT&&(X=i.RGB16UI),L===i.UNSIGNED_INT&&(X=i.RGB32UI),L===i.BYTE&&(X=i.RGB8I),L===i.SHORT&&(X=i.RGB16I),L===i.INT&&(X=i.RGB32I)),g===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),L===i.UNSIGNED_INT&&(X=i.RGBA32UI),L===i.BYTE&&(X=i.RGBA8I),L===i.SHORT&&(X=i.RGBA16I),L===i.INT&&(X=i.RGBA32I)),g===i.RGB&&(L===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),g===i.RGBA){const Se=j?fs:je.getTransfer(W);L===i.FLOAT&&(X=i.RGBA32F),L===i.HALF_FLOAT&&(X=i.RGBA16F),L===i.UNSIGNED_BYTE&&(X=Se===et?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function S(T,g){let L;return T?g===null||g===an||g===Pi?L=i.DEPTH24_STENCIL8:g===en?L=i.DEPTH32F_STENCIL8:g===Ci&&(L=i.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===an||g===Pi?L=i.DEPTH_COMPONENT24:g===en?L=i.DEPTH_COMPONENT32F:g===Ci&&(L=i.DEPTH_COMPONENT16),L}function A(T,g){return p(T)===!0||T.isFramebufferTexture&&T.minFilter!==Et&&T.minFilter!==_t?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function w(T){const g=T.target;g.removeEventListener("dispose",w),U(g),g.isVideoTexture&&u.delete(g)}function R(T){const g=T.target;g.removeEventListener("dispose",R),y(g)}function U(T){const g=n.get(T);if(g.__webglInit===void 0)return;const L=T.source,W=f.get(L);if(W){const j=W[g.__cacheKey];j.usedTimes--,j.usedTimes===0&&v(T),Object.keys(W).length===0&&f.delete(L)}n.remove(T)}function v(T){const g=n.get(T);i.deleteTexture(g.__webglTexture);const L=T.source,W=f.get(L);delete W[g.__cacheKey],a.memory.textures--}function y(T){const g=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(g.__webglFramebuffer[W]))for(let j=0;j<g.__webglFramebuffer[W].length;j++)i.deleteFramebuffer(g.__webglFramebuffer[W][j]);else i.deleteFramebuffer(g.__webglFramebuffer[W]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[W])}else{if(Array.isArray(g.__webglFramebuffer))for(let W=0;W<g.__webglFramebuffer.length;W++)i.deleteFramebuffer(g.__webglFramebuffer[W]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let W=0;W<g.__webglColorRenderbuffer.length;W++)g.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[W]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const L=T.textures;for(let W=0,j=L.length;W<j;W++){const X=n.get(L[W]);X.__webglTexture&&(i.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(L[W])}n.remove(T)}let P=0;function B(){P=0}function F(){const T=P;return T>=s.maxTextures&&Ie("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),P+=1,T}function V(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function q(T,g){const L=n.get(T);if(T.isVideoTexture&&Ke(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&L.__version!==T.version){const W=T.image;if(W===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{Y(L,T,g);return}}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+g)}function z(T,g){const L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){Y(L,T,g);return}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+g)}function H(T,g){const L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){Y(L,T,g);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+g)}function K(T,g){const L=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&L.__version!==T.version){$(L,T,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+g)}const ie={[Ri]:i.REPEAT,[mn]:i.CLAMP_TO_EDGE,[fr]:i.MIRRORED_REPEAT},te={[Et]:i.NEAREST,[Xc]:i.NEAREST_MIPMAP_NEAREST,[Gi]:i.NEAREST_MIPMAP_LINEAR,[_t]:i.LINEAR,[Es]:i.LINEAR_MIPMAP_NEAREST,[Vn]:i.LINEAR_MIPMAP_LINEAR},re={[jc]:i.NEVER,[Qc]:i.ALWAYS,[$c]:i.LESS,[ia]:i.LEQUAL,[Kc]:i.EQUAL,[sa]:i.GEQUAL,[Zc]:i.GREATER,[Jc]:i.NOTEQUAL};function ne(T,g){if(g.type===en&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===_t||g.magFilter===Es||g.magFilter===Gi||g.magFilter===Vn||g.minFilter===_t||g.minFilter===Es||g.minFilter===Gi||g.minFilter===Vn)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,ie[g.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,ie[g.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,ie[g.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,te[g.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,te[g.minFilter]),g.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,re[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Et||g.minFilter!==Gi&&g.minFilter!==Vn||g.type===en&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Pe(T,g){let L=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",w));const W=g.source;let j=f.get(W);j===void 0&&(j={},f.set(W,j));const X=V(g);if(X!==T.__cacheKey){j[X]===void 0&&(j[X]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,L=!0),j[X].usedTimes++;const Se=j[T.__cacheKey];Se!==void 0&&(j[T.__cacheKey].usedTimes--,Se.usedTimes===0&&v(g)),T.__cacheKey=X,T.__webglTexture=j[X].texture}return L}function Fe(T,g,L){return Math.floor(Math.floor(T/L)/g)}function Ve(T,g,L,W){const X=T.updateRanges;if(X.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,L,W,g.data);else{X.sort((Q,ce)=>Q.start-ce.start);let Se=0;for(let Q=1;Q<X.length;Q++){const ce=X[Se],Me=X[Q],Ee=ce.start+ce.count,oe=Fe(Me.start,g.width,4),ze=Fe(ce.start,g.width,4);Me.start<=Ee+1&&oe===ze&&Fe(Me.start+Me.count-1,g.width,4)===oe?ce.count=Math.max(ce.count,Me.start+Me.count-ce.start):(++Se,X[Se]=Me)}X.length=Se+1;const ae=i.getParameter(i.UNPACK_ROW_LENGTH),ye=i.getParameter(i.UNPACK_SKIP_PIXELS),Ce=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Q=0,ce=X.length;Q<ce;Q++){const Me=X[Q],Ee=Math.floor(Me.start/4),oe=Math.ceil(Me.count/4),ze=Ee%g.width,D=Math.floor(Ee/g.width),fe=oe,ee=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,ze),i.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,ze,D,fe,ee,L,W,g.data)}T.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ae),i.pixelStorei(i.UNPACK_SKIP_PIXELS,ye),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ce)}}function Y(T,g,L){let W=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(W=i.TEXTURE_3D);const j=Pe(T,g),X=g.source;t.bindTexture(W,T.__webglTexture,i.TEXTURE0+L);const Se=n.get(X);if(X.version!==Se.__version||j===!0){t.activeTexture(i.TEXTURE0+L);const ae=je.getPrimaries(je.workingColorSpace),ye=g.colorSpace===Rn?null:je.getPrimaries(g.colorSpace),Ce=g.colorSpace===Rn||ae===ye?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ce);let Q=x(g.image,!1,s.maxTextureSize);Q=tt(g,Q);const ce=r.convert(g.format,g.colorSpace),Me=r.convert(g.type);let Ee=b(g.internalFormat,ce,Me,g.colorSpace,g.isVideoTexture);ne(W,g);let oe;const ze=g.mipmaps,D=g.isVideoTexture!==!0,fe=Se.__version===void 0||j===!0,ee=X.dataReady,pe=A(g,Q);if(g.isDepthTexture)Ee=S(g.format===Hn,g.type),fe&&(D?t.texStorage2D(i.TEXTURE_2D,1,Ee,Q.width,Q.height):t.texImage2D(i.TEXTURE_2D,0,Ee,Q.width,Q.height,0,ce,Me,null));else if(g.isDataTexture)if(ze.length>0){D&&fe&&t.texStorage2D(i.TEXTURE_2D,pe,Ee,ze[0].width,ze[0].height);for(let J=0,Z=ze.length;J<Z;J++)oe=ze[J],D?ee&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,oe.width,oe.height,ce,Me,oe.data):t.texImage2D(i.TEXTURE_2D,J,Ee,oe.width,oe.height,0,ce,Me,oe.data);g.generateMipmaps=!1}else D?(fe&&t.texStorage2D(i.TEXTURE_2D,pe,Ee,Q.width,Q.height),ee&&Ve(g,Q,ce,Me)):t.texImage2D(i.TEXTURE_2D,0,Ee,Q.width,Q.height,0,ce,Me,Q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){D&&fe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,Ee,ze[0].width,ze[0].height,Q.depth);for(let J=0,Z=ze.length;J<Z;J++)if(oe=ze[J],g.format!==$t)if(ce!==null)if(D){if(ee)if(g.layerUpdates.size>0){const se=Qa(oe.width,oe.height,g.format,g.type);for(const Le of g.layerUpdates){const at=oe.data.subarray(Le*se/oe.data.BYTES_PER_ELEMENT,(Le+1)*se/oe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,Le,oe.width,oe.height,1,ce,at)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,oe.width,oe.height,Q.depth,ce,oe.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,J,Ee,oe.width,oe.height,Q.depth,0,oe.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?ee&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,J,0,0,0,oe.width,oe.height,Q.depth,ce,Me,oe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,J,Ee,oe.width,oe.height,Q.depth,0,ce,Me,oe.data)}else{D&&fe&&t.texStorage2D(i.TEXTURE_2D,pe,Ee,ze[0].width,ze[0].height);for(let J=0,Z=ze.length;J<Z;J++)oe=ze[J],g.format!==$t?ce!==null?D?ee&&t.compressedTexSubImage2D(i.TEXTURE_2D,J,0,0,oe.width,oe.height,ce,oe.data):t.compressedTexImage2D(i.TEXTURE_2D,J,Ee,oe.width,oe.height,0,oe.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?ee&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,oe.width,oe.height,ce,Me,oe.data):t.texImage2D(i.TEXTURE_2D,J,Ee,oe.width,oe.height,0,ce,Me,oe.data)}else if(g.isDataArrayTexture)if(D){if(fe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,Ee,Q.width,Q.height,Q.depth),ee)if(g.layerUpdates.size>0){const J=Qa(Q.width,Q.height,g.format,g.type);for(const Z of g.layerUpdates){const se=Q.data.subarray(Z*J/Q.data.BYTES_PER_ELEMENT,(Z+1)*J/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Z,Q.width,Q.height,1,ce,Me,se)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ce,Me,Q.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ee,Q.width,Q.height,Q.depth,0,ce,Me,Q.data);else if(g.isData3DTexture)D?(fe&&t.texStorage3D(i.TEXTURE_3D,pe,Ee,Q.width,Q.height,Q.depth),ee&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ce,Me,Q.data)):t.texImage3D(i.TEXTURE_3D,0,Ee,Q.width,Q.height,Q.depth,0,ce,Me,Q.data);else if(g.isFramebufferTexture){if(fe)if(D)t.texStorage2D(i.TEXTURE_2D,pe,Ee,Q.width,Q.height);else{let J=Q.width,Z=Q.height;for(let se=0;se<pe;se++)t.texImage2D(i.TEXTURE_2D,se,Ee,J,Z,0,ce,Me,null),J>>=1,Z>>=1}}else if(ze.length>0){if(D&&fe){const J=ve(ze[0]);t.texStorage2D(i.TEXTURE_2D,pe,Ee,J.width,J.height)}for(let J=0,Z=ze.length;J<Z;J++)oe=ze[J],D?ee&&t.texSubImage2D(i.TEXTURE_2D,J,0,0,ce,Me,oe):t.texImage2D(i.TEXTURE_2D,J,Ee,ce,Me,oe);g.generateMipmaps=!1}else if(D){if(fe){const J=ve(Q);t.texStorage2D(i.TEXTURE_2D,pe,Ee,J.width,J.height)}ee&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ce,Me,Q)}else t.texImage2D(i.TEXTURE_2D,0,Ee,ce,Me,Q);p(g)&&h(W),Se.__version=X.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function $(T,g,L){if(g.image.length!==6)return;const W=Pe(T,g),j=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+L);const X=n.get(j);if(j.version!==X.__version||W===!0){t.activeTexture(i.TEXTURE0+L);const Se=je.getPrimaries(je.workingColorSpace),ae=g.colorSpace===Rn?null:je.getPrimaries(g.colorSpace),ye=g.colorSpace===Rn||Se===ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye);const Ce=g.isCompressedTexture||g.image[0].isCompressedTexture,Q=g.image[0]&&g.image[0].isDataTexture,ce=[];for(let Z=0;Z<6;Z++)!Ce&&!Q?ce[Z]=x(g.image[Z],!0,s.maxCubemapSize):ce[Z]=Q?g.image[Z].image:g.image[Z],ce[Z]=tt(g,ce[Z]);const Me=ce[0],Ee=r.convert(g.format,g.colorSpace),oe=r.convert(g.type),ze=b(g.internalFormat,Ee,oe,g.colorSpace),D=g.isVideoTexture!==!0,fe=X.__version===void 0||W===!0,ee=j.dataReady;let pe=A(g,Me);ne(i.TEXTURE_CUBE_MAP,g);let J;if(Ce){D&&fe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,ze,Me.width,Me.height);for(let Z=0;Z<6;Z++){J=ce[Z].mipmaps;for(let se=0;se<J.length;se++){const Le=J[se];g.format!==$t?Ee!==null?D?ee&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,se,0,0,Le.width,Le.height,Ee,Le.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,se,ze,Le.width,Le.height,0,Le.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,se,0,0,Le.width,Le.height,Ee,oe,Le.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,se,ze,Le.width,Le.height,0,Ee,oe,Le.data)}}}else{if(J=g.mipmaps,D&&fe){J.length>0&&pe++;const Z=ve(ce[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,ze,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(Q){D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,ce[Z].width,ce[Z].height,Ee,oe,ce[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,ze,ce[Z].width,ce[Z].height,0,Ee,oe,ce[Z].data);for(let se=0;se<J.length;se++){const at=J[se].image[Z].image;D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,se+1,0,0,at.width,at.height,Ee,oe,at.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,se+1,ze,at.width,at.height,0,Ee,oe,at.data)}}else{D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Ee,oe,ce[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,ze,Ee,oe,ce[Z]);for(let se=0;se<J.length;se++){const Le=J[se];D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,se+1,0,0,Ee,oe,Le.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,se+1,ze,Ee,oe,Le.image[Z])}}}p(g)&&h(i.TEXTURE_CUBE_MAP),X.__version=j.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function le(T,g,L,W,j,X){const Se=r.convert(L.format,L.colorSpace),ae=r.convert(L.type),ye=b(L.internalFormat,Se,ae,L.colorSpace),Ce=n.get(g),Q=n.get(L);if(Q.__renderTarget=g,!Ce.__hasExternalTextures){const ce=Math.max(1,g.width>>X),Me=Math.max(1,g.height>>X);j===i.TEXTURE_3D||j===i.TEXTURE_2D_ARRAY?t.texImage3D(j,X,ye,ce,Me,g.depth,0,Se,ae,null):t.texImage2D(j,X,ye,ce,Me,0,Se,ae,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),dt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,j,Q.__webglTexture,0,C(g)):(j===i.TEXTURE_2D||j>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,j,Q.__webglTexture,X),t.bindFramebuffer(i.FRAMEBUFFER,null)}function we(T,g,L){if(i.bindRenderbuffer(i.RENDERBUFFER,T),g.depthBuffer){const W=g.depthTexture,j=W&&W.isDepthTexture?W.type:null,X=S(g.stencilBuffer,j),Se=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;dt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,C(g),X,g.width,g.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,C(g),X,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,X,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Se,i.RENDERBUFFER,T)}else{const W=g.textures;for(let j=0;j<W.length;j++){const X=W[j],Se=r.convert(X.format,X.colorSpace),ae=r.convert(X.type),ye=b(X.internalFormat,Se,ae,X.colorSpace);dt(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,C(g),ye,g.width,g.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,C(g),ye,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ye,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function me(T,g,L){const W=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const j=n.get(g.depthTexture);if(j.__renderTarget=g,(!j.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),W){if(j.__webglInit===void 0&&(j.__webglInit=!0,g.depthTexture.addEventListener("dispose",w)),j.__webglTexture===void 0){j.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),ne(i.TEXTURE_CUBE_MAP,g.depthTexture);const Ce=r.convert(g.depthTexture.format),Q=r.convert(g.depthTexture.type);let ce;g.depthTexture.format===Sn?ce=i.DEPTH_COMPONENT24:g.depthTexture.format===Hn&&(ce=i.DEPTH24_STENCIL8);for(let Me=0;Me<6;Me++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,ce,g.width,g.height,0,Ce,Q,null)}}else q(g.depthTexture,0);const X=j.__webglTexture,Se=C(g),ae=W?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,ye=g.depthTexture.format===Hn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===Sn)dt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ye,ae,X,0,Se):i.framebufferTexture2D(i.FRAMEBUFFER,ye,ae,X,0);else if(g.depthTexture.format===Hn)dt(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ye,ae,X,0,Se):i.framebufferTexture2D(i.FRAMEBUFFER,ye,ae,X,0);else throw new Error("Unknown depthTexture format")}function ke(T){const g=n.get(T),L=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const W=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),W){const j=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,W.removeEventListener("dispose",j)};W.addEventListener("dispose",j),g.__depthDisposeCallback=j}g.__boundDepthTexture=W}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(L)for(let W=0;W<6;W++)me(g.__webglFramebuffer[W],T,W);else{const W=T.texture.mipmaps;W&&W.length>0?me(g.__webglFramebuffer[0],T,0):me(g.__webglFramebuffer,T,0)}else if(L){g.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[W]),g.__webglDepthbuffer[W]===void 0)g.__webglDepthbuffer[W]=i.createRenderbuffer(),we(g.__webglDepthbuffer[W],T,!1);else{const j=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=g.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,X)}}else{const W=T.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),we(g.__webglDepthbuffer,T,!1);else{const j=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,X)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function lt(T,g,L){const W=n.get(T);g!==void 0&&le(W.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&ke(T)}function De(T){const g=T.texture,L=n.get(T),W=n.get(g);T.addEventListener("dispose",R);const j=T.textures,X=T.isWebGLCubeRenderTarget===!0,Se=j.length>1;if(Se||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=g.version,a.memory.textures++),X){L.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer[ae]=[];for(let ye=0;ye<g.mipmaps.length;ye++)L.__webglFramebuffer[ae][ye]=i.createFramebuffer()}else L.__webglFramebuffer[ae]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){L.__webglFramebuffer=[];for(let ae=0;ae<g.mipmaps.length;ae++)L.__webglFramebuffer[ae]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(Se)for(let ae=0,ye=j.length;ae<ye;ae++){const Ce=n.get(j[ae]);Ce.__webglTexture===void 0&&(Ce.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&dt(T)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ae=0;ae<j.length;ae++){const ye=j[ae];L.__webglColorRenderbuffer[ae]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[ae]);const Ce=r.convert(ye.format,ye.colorSpace),Q=r.convert(ye.type),ce=b(ye.internalFormat,Ce,Q,ye.colorSpace,T.isXRRenderTarget===!0),Me=C(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,Me,ce,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ae,i.RENDERBUFFER,L.__webglColorRenderbuffer[ae])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),we(L.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(X){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),ne(i.TEXTURE_CUBE_MAP,g);for(let ae=0;ae<6;ae++)if(g.mipmaps&&g.mipmaps.length>0)for(let ye=0;ye<g.mipmaps.length;ye++)le(L.__webglFramebuffer[ae][ye],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,ye);else le(L.__webglFramebuffer[ae],T,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);p(g)&&h(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Se){for(let ae=0,ye=j.length;ae<ye;ae++){const Ce=j[ae],Q=n.get(Ce);let ce=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ce=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ce,Q.__webglTexture),ne(ce,Ce),le(L.__webglFramebuffer,T,Ce,i.COLOR_ATTACHMENT0+ae,ce,0),p(Ce)&&h(ce)}t.unbindTexture()}else{let ae=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ae=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,W.__webglTexture),ne(ae,g),g.mipmaps&&g.mipmaps.length>0)for(let ye=0;ye<g.mipmaps.length;ye++)le(L.__webglFramebuffer[ye],T,g,i.COLOR_ATTACHMENT0,ae,ye);else le(L.__webglFramebuffer,T,g,i.COLOR_ATTACHMENT0,ae,0);p(g)&&h(ae),t.unbindTexture()}T.depthBuffer&&ke(T)}function We(T){const g=T.textures;for(let L=0,W=g.length;L<W;L++){const j=g[L];if(p(j)){const X=E(T),Se=n.get(j).__webglTexture;t.bindTexture(X,Se),h(X),t.unbindTexture()}}}const $e=[],Ue=[];function it(T){if(T.samples>0){if(dt(T)===!1){const g=T.textures,L=T.width,W=T.height;let j=i.COLOR_BUFFER_BIT;const X=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Se=n.get(T),ae=g.length>1;if(ae)for(let Ce=0;Ce<g.length;Ce++)t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Se.__webglMultisampledFramebuffer);const ye=T.texture.mipmaps;ye&&ye.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglFramebuffer);for(let Ce=0;Ce<g.length;Ce++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(j|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(j|=i.STENCIL_BUFFER_BIT)),ae){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Se.__webglColorRenderbuffer[Ce]);const Q=n.get(g[Ce]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Q,0)}i.blitFramebuffer(0,0,L,W,0,0,L,W,j,i.NEAREST),l===!0&&($e.length=0,Ue.length=0,$e.push(i.COLOR_ATTACHMENT0+Ce),T.depthBuffer&&T.resolveDepthBuffer===!1&&($e.push(X),Ue.push(X),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ue)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,$e))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ae)for(let Ce=0;Ce<g.length;Ce++){t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.RENDERBUFFER,Se.__webglColorRenderbuffer[Ce]);const Q=n.get(g[Ce]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ce,i.TEXTURE_2D,Q,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function C(T){return Math.min(s.maxSamples,T.samples)}function dt(T){const g=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Ke(T){const g=a.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function tt(T,g){const L=T.colorSpace,W=T.format,j=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||L!==pi&&L!==Rn&&(je.getTransfer(L)===et?(W!==$t||j!==zt)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ye("WebGLTextures: Unsupported texture color space:",L)),g}function ve(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=B,this.setTexture2D=q,this.setTexture2DArray=z,this.setTexture3D=H,this.setTextureCube=K,this.rebindTextures=lt,this.setupRenderTarget=De,this.updateRenderTargetMipmap=We,this.updateMultisampleRenderTarget=it,this.setupDepthRenderbuffer=ke,this.setupFrameBufferTexture=le,this.useMultisampledRTT=dt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Rp(i,e){function t(n,s=Rn){let r;const a=je.getTransfer(s);if(n===zt)return i.UNSIGNED_BYTE;if(n===Jr)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Qr)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Bo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===ko)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Fo)return i.BYTE;if(n===Oo)return i.SHORT;if(n===Ci)return i.UNSIGNED_SHORT;if(n===Zr)return i.INT;if(n===an)return i.UNSIGNED_INT;if(n===en)return i.FLOAT;if(n===Mn)return i.HALF_FLOAT;if(n===zo)return i.ALPHA;if(n===Go)return i.RGB;if(n===$t)return i.RGBA;if(n===Sn)return i.DEPTH_COMPONENT;if(n===Hn)return i.DEPTH_STENCIL;if(n===Vo)return i.RED;if(n===ea)return i.RED_INTEGER;if(n===fi)return i.RG;if(n===ta)return i.RG_INTEGER;if(n===na)return i.RGBA_INTEGER;if(n===cs||n===ls||n===hs||n===us)if(a===et)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===cs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ls)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===hs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===us)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===cs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ls)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===hs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===us)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===pr||n===mr||n===gr||n===_r)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===pr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===mr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===gr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===_r)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===xr||n===vr||n===Mr||n===Sr||n===yr||n===Er||n===br)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===xr||n===vr)return a===et?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Mr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Sr)return r.COMPRESSED_R11_EAC;if(n===yr)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Er)return r.COMPRESSED_RG11_EAC;if(n===br)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Tr||n===Ar||n===wr||n===Rr||n===Cr||n===Pr||n===Dr||n===Lr||n===Ir||n===Ur||n===Nr||n===Fr||n===Or||n===Br)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Tr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ar)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===wr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Rr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Cr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Pr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Dr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Lr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ir)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ur)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Nr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Fr)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Or)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Br)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===kr||n===zr||n===Gr)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===kr)return a===et?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===zr)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Gr)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Vr||n===Hr||n===Wr||n===Xr)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Vr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Hr)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Wr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Xr)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Pi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Cp=`
void main() {
