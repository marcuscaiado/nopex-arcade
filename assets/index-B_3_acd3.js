...
#define LOW_PRECISION`),e}const Zf={[ar]:"SHADOWMAP_TYPE_PCF",[bi]:"SHADOWMAP_TYPE_VSM"};function Kf(i){return Zf[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const jf={[kn]:"ENVMAP_TYPE_CUBE",[ci]:"ENVMAP_TYPE_CUBE",[mr]:"ENVMAP_TYPE_CUBE_UV"};function $f(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":jf[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Jf={[ci]:"ENVMAP_MODE_REFRACTION"};function Qf(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Jf[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const ep={[bo]:"ENVMAP_BLENDING_MULTIPLY",[Vc]:"ENVMAP_BLENDING_MIX",[Gc]:"ENVMAP_BLENDING_ADD"};function tp(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":ep[i.combine]||"ENVMAP_BLENDING_NONE"}function np(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function ip(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Kf(t),c=$f(t),u=Qf(t),d=tp(t),f=np(t),m=Vf(t),_=Gf(s),v=r.createProgram();let p,h,E=t.glslVersion?"#version "+t.glslVersion+`
