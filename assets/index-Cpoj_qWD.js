...
#define LOW_PRECISION`),e}const Ff={[sr]:"SHADOWMAP_TYPE_PCF",[yi]:"SHADOWMAP_TYPE_VSM"};function Of(i){return Ff[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Bf={[kn]:"ENVMAP_TYPE_CUBE",[ci]:"ENVMAP_TYPE_CUBE",[pr]:"ENVMAP_TYPE_CUBE_UV"};function zf(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Bf[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Vf={[ci]:"ENVMAP_MODE_REFRACTION"};function Gf(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Vf[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const kf={[vo]:"ENVMAP_BLENDING_MULTIPLY",[Rc]:"ENVMAP_BLENDING_MIX",[Cc]:"ENVMAP_BLENDING_ADD"};function Hf(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":kf[i.combine]||"ENVMAP_BLENDING_NONE"}function Wf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Xf(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Of(t),c=zf(t),d=Gf(t),u=Hf(t),f=Wf(t),p=Rf(t),_=Cf(s),M=r.createProgram();let m,h,T=t.glslVersion?"#version "+t.glslVersion+`
